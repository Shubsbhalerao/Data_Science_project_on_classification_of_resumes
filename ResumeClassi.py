...
def main():
    st.set_page_config(
        ...
        page_icon='https://img.freepik.com/premium-vector/flow-chart-icon-vector-design_116137-5356.jpg?w=1480',
        layout= "wide"
    )
    ...
    path = r"C:\Users\bhale\project 2 NLP\Resumes\Resumes\all_resumes"
    #if path is not None:
    #    try:
    ...
    if load or st.session_state.load_state:
        ...
        if opt == "Pie chart":
            ...
            with col6:
                ...
                wordcloud = WordCloud(width=800, height=800, random_state=21, max_font_size=110).generate(' '.join(path))
